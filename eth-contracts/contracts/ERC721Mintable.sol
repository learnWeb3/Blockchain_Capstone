...
contract Ownable {
  ...
  function transferOwnership(address newOwner) public onlyOwner {
    ...
    require(newOwner != address(0), "incorrect address format");
    _owner = newOwner;
  }
...
contract ERC721 is Ownable, Pausable, ERC165 {
  ...
  constructor() public Ownable() Pausable() {
  ...
  function approve(address to, uint256 tokenId) public {
    ...
    require(to != tokenOwner, "recipient must not be token owner");
    // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
    require(isOwner(msg.sender) || isApprovedForAll(tokenOwner, msg.sender));
  ...
  function _transferFrom(
    ...
    require(from == ownerOf(tokenId), "from must be token owner");
